...
import com.example.shwemisale.databinding.FragmentCustomerInfoPawnBinding

class PawnCustomerInfoFragment:Fragment() {

    lateinit var binding:FragmentCustomerInfoPawnBinding
    ...
    override fun onCreateView(
        ...
        return FragmentCustomerInfoPawnBinding.inflate(inflater).also {
            binding= it
        }.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnContinue.setOnClickListener {
            view.findNavController().navigate(PawnCustomerInfoFragmentDirections.actionPawnCustomerInfoFragmentToPawnGoldFromHomeFragment())
        }
