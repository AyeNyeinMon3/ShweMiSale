...
class PawnResellStockInfoAddedFragment:Fragment (){

    lateinit var binding: FragmentResellStockInfoAddedPawnBinding
    ...
    override fun onCreateView(
        ...
        return FragmentResellStockInfoAddedPawnBinding.inflate(inflater).also {
            binding = it
        }.root
    }
