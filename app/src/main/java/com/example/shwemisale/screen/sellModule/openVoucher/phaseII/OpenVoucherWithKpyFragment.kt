package com.example.shwemisale.screen.sellModule.openVoucher.phaseII
...
import com.example.shwemisale.databinding.FragmentOpenVoucherWithKpyBinding
import com.example.shwemisale.printerHelper.printPdf
import com.example.shwemisale.screen.goldFromHome.getKPYFromYwae
import com.example.shwemisale.screen.sellModule.openVoucher.withKPY.WithKPYViewModel
...
class OpenVoucherWithKpyFragment : Fragment() {
    ...
    private val args by navArgs<OpenVoucherWithKpyFragmentArgs>()
...
//                .let { if (it.isEmpty()) 0 else it.toInt() })
        ...
        binding.includeOldStockWeightLayout.btnEditOldStockWeight.setOnClickListener {
            findNavController().navigate(
                OpenVoucherWithKpyFragmentDirections.actionGlobalGoldFromHomeFragment(
                    "Global",
                    null
                )
            )
