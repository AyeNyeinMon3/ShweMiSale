...
import com.shwemigoldshop.shwemisale.databinding.DialogExchangeOrderBinding
import com.shwemigoldshop.shwemisale.databinding.FragmentExchangeOrderBinding
...
class ExchangeOrderFragment : Fragment() {
    ...
    private val args by navArgs<com.shwemigoldshop.shwemisale.screen.sellModule.exchangeOrderAndOldItem.ExchangeOrderFragmentArgs>()
            ...
            when (it) {
                ...
                is Resource.Success -> {
                    ...
                    view.findNavController().navigate(
                        com.shwemigoldshop.shwemisale.screen.sellModule.exchangeOrderAndOldItem.ExchangeOrderFragmentDirections.actionExchangeOrderFragmentToOpenVoucherWithKpyFragment(
    ...
    fun showExchangeOrderDialog() {
        ...
        dialogExchangeOrderBinding.btnWithValue.setOnClickListener {
            view?.findNavController()
                ?.navigate(
                    com.shwemigoldshop.shwemisale.screen.sellModule.exchangeOrderAndOldItem.ExchangeOrderFragmentDirections.actionExchangeOrderFragmentToWithValueFragment(
                        args.scannedProducts,
                        generateNumberFromEditText(binding.edtOldVoucherPayment).toInt(),
                        if (binding.edtGoldFromHomeVoucher.text.isNullOrEmpty()) null else binding.edtGoldFromHomeVoucher.text.toString()
                    )
