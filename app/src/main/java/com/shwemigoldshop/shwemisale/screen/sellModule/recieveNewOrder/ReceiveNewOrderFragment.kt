package com.shwemigoldshop.shwemisale.screen.sellModule.recieveNewOrder
...
import com.shwemigoldshop.shwemisale.databinding.FragmentReceiveNewOrderBinding
...
import com.shwemigoldshop.shwemisale.screen.sellModule.SampleListRecyclerAdapter
...
//                    Toast.makeText(requireContext(),"log out successful", Toast.LENGTH_LONG).show()
        ...
        binding.btnEditGoldFromHomeValue.setOnClickListener {
            findNavController().navigate(
                com.shwemigoldshop.shwemisale.screen.sellModule.recieveNewOrder.ReceiveNewOrderFragmentDirections.actionGlobalGoldFromHomeFragment(
                    "Global",
                    null
                )
            )
        ...
        binding.btnInventory.setOnClickListener {
            view.findNavController()
                .navigate(com.shwemigoldshop.shwemisale.screen.sellModule.recieveNewOrder.ReceiveNewOrderFragmentDirections.actionReceiveNewOrderFragmentToInventoryStockFragment())
        }
        binding.btnOutside.setOnClickListener {
            view.findNavController()
                .navigate(com.shwemigoldshop.shwemisale.screen.sellModule.recieveNewOrder.ReceiveNewOrderFragmentDirections.actionReceiveNewOrderFragmentToOutsideStockFragment())
        }
