...
import com.shwemigoldshop.shwemisale.databinding.FragmentCreateNewSellBinding
            ...
            when(it){
                ...
                is Resource.Success->{
                    ...
                    requireContext().showSuccessDialog("Customer was successfully created"){
                        ...
                        view.findNavController().navigate(com.shwemigoldshop.shwemisale.screen.sellModule.addUser.SellCreateNewFragmentDirections.actionSellCreateNewFragmentToSellCustomerInfoFragment(it.data!!.asUiModel()))
                    }
                }
                is Resource.Error->{
                    loading.dismiss()
