...
import com.shwemigoldshop.shwemisale.databinding.DialogAkoukSellAddProductBinding
import com.shwemigoldshop.shwemisale.databinding.FragmentAkoukSellBinding
...
//                    Toast.makeText(requireContext(),"log out successful", Toast.LENGTH_LONG).show()
        ...
        binding.includePayment.btnEdit.setOnClickListener {
            findNavController().navigate(
                com.shwemigoldshop.shwemisale.screen.sellModule.goldBlockSale.AkoukSellFragmentDirections.actionGlobalGoldFromHomeFragment(
                    "Global",
                    null
                )
            )
