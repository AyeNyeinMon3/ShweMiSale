...
import com.shwemigoldshop.shwemisale.data_layers.dto.goldFromHome.Image
import com.shwemigoldshop.shwemisale.databinding.FragmentOldStockAddToBucketBinding
...
import com.shwemigoldshop.shwemisale.screen.goldFromHome.bucket.RemoveImageSelectionListener
import com.shwemigoldshop.shwemisale.screen.goldFromHome.getGramFromYwae
        ...
        if (binding.includeOldStockAddItemPhoto.radioGm.isChecked) {
            ...
            shareViewModel.addToOldStockBucket(
                StockFromHomeDomain(
                    ...
                    e_price_from_new_voucher = viewModel.getEValue(),
